...
Lightbox.prototype.loadIframe = function () {
    this.body.innerHTML =
        '<iframe src="' +
        this.href +
        '" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin"></iframe>' +
        '<h2 class="glitch">' +
        (this.title || "") +
        "</h2>" +
        "<p>" +
